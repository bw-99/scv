...
class SSLViTDCNv3(BaseModel):
    def __init__(self,
                 feature_map,
                 model_id="SSLViTDCNv3",
                 gpu=-1,
                 learning_rate=1e-3,
                 embedding_dim=10,
                 ...
                 **kwargs):
        super(SSLViTDCNv3, self).__init__(feature_map,
                                    model_id=model_id,
                                    gpu=gpu,
    ...
    def forward(self, inputs):
        ...
        dlogit, dmask_candidates = self.ECN(feature_emb)
        dlogit = dlogit.mean(dim=1)
        slogit, smask_candidates = self.LCN(feature_emb)
        slogit = slogit.mean(dim=1)
        ...
        return_dict = {"y_pred": y_pred,
                       ...
                       "dmask_candidates": dmask_candidates,
                       "smask_candidates": smask_candidates
                       }
        return return_dict
