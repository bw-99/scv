...
class GNNv1_v6(BaseModel):
    def __init__(self,
                 ...
                 **kwargs):
        super(GNNv1_v6, self).__init__(feature_map,
                                    model_id=model_id,
                                    gpu=gpu,
        ...
        print("GNNv1_v6GNNv1_v6GNNv1_v6GNNv1_v6GNNv1_v6 input_dim", input_dim)
...
class CrossNetwork(nn.Module):
    def __init__(self,
        ...
        for i in range(self.num_hops):
            self.convs.append(SAGEConv2(embedding_dim, embedding_dim, nomalize_adj=nomalize_adj))
