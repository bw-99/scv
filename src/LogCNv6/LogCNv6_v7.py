...
class LogCNv6_v7(BaseModel):
    def __init__(self,
                 ...
                 **kwargs):
        super(LogCNv6_v7, self).__init__(feature_map,
                                    model_id=model_id,
                                    gpu=gpu,
        ...
        print("LogCNv6_v7LogCNv6_v7LogCNv6_v7LogCNv6_v7LogCNv6_v7 input_dim", input_dim)
    ...
    def train_step(self, inputs):
        ...
        sub_loss = torch.stack(sub_loss_lst, dim=-1).sum()
