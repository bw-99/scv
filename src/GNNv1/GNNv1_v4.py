...
class GNNv1_v4(BaseModel):
    def __init__(self,
                 ...
                 **kwargs):
        super(GNNv1_v4, self).__init__(feature_map,
                                    model_id=model_id,
                                    gpu=gpu,
        ...
        print("GNNv1_v4GNNv1_v4GNNv1_v4GNNv1_v4GNNv1_v4 input_dim", input_dim)
...
class CrossNetwork(nn.Module):
    ...
    def forward(self, x):
        for idx in range(self.num_hops):
            ...
            x = self.convs[idx](x, adj_matrix) + x
