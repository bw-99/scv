...
# * gnnv3_v3 + normal sageconv

class GNNv3_v6(BaseModel):
    def __init__(self,
                 feature_map,
                 model_id="GNNv3_v6",
                 gpu=-1,
                 ...
                 **kwargs):
        super(GNNv3_v6, self).__init__(feature_map,
                                    model_id=model_id,
                                    gpu=gpu,
        ...
        print("GNNv3_v6GNNv3_v6GNNv3_v6GNNv3_v6GNNv3_v6 input_dim", input_dim)
