...
# * gnnv3_v7 + netdropout, gnndropout
...
class GNNv3_v7(BaseModel):
    def __init__(self,
                 ...
                 **kwargs):
        super(GNNv3_v7, self).__init__(feature_map,
                                    model_id=model_id,
                                    gpu=gpu,
        ...
        print("GNNv3_v7GNNv3_v7GNNv3_v7GNNv3_v7GNNv3_v7 input_dim", input_dim)

        self.gnn_tower = nn.ModuleList([
            CrossNetwork(
                num_fields=self.num_fields,
                embedding_dim=embedding_dim,
                net_dropout=gnn_dropout,
                num_hops=num_hops,
    ...
    def forward(self, inputs):
        ...
        final_emb = torch.cat([gnn_emb_lst, dnn_emb], dim=-1)
