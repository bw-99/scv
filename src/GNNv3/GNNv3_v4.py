...
class GNNv3_v4(BaseModel):
    def __init__(self,
                 ...
                 **kwargs):
        super(GNNv3_v4, self).__init__(feature_map,
                                    model_id=model_id,
                                    gpu=gpu,
        ...
        print("GNNv3_v4GNNv3_v4GNNv3_v4GNNv3_v4GNNv3_v4 input_dim", input_dim)
        ...
        self.parallel_dnn = MLP_Block(input_dim=input_dim,
                                          ...
                                          batch_norm=batch_norm)
        final_dim = final_dim + parallel_dnn_hidden_units[-1]
