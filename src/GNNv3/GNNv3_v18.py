...
class GNNv3_v18(BaseModel):
    def __init__(self,
                 ...
                 **kwargs):
        super(GNNv3_v18, self).__init__(feature_map,
                                       model_id=model_id,
                                       gpu=gpu,
        ...
        print("GNNv3_v18 input_dim", input_dim)
        ...
        if self.use_bilinear_fusion:
            ...
            concat_dim = embedding_dim * self.num_fields + parallel_dnn_hidden_units[-1]
            print("concat_dim ", concat_dim)
