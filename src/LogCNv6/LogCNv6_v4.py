...
class LogCNv6_v4(BaseModel):
    def __init__(self,
                 ...
                 **kwargs):
        super(LogCNv6_v4, self).__init__(feature_map,
                                    model_id=model_id,
                                    gpu=gpu,
        ...
        print("LogCNv6_v4LogCNv6_v4LogCNv6_v4LogCNv6_v4LogCNv6_v4 input_dim", input_dim)
    ...
    def train_step(self, inputs):
        ...
        # target_loss = torch.stack([loss for _ in range(logit_lst.shape[0])], dim=-1)
        # additional_loss = self.loss_fn(logit_lst, target_loss, reduction='mean')
